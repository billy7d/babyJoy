...
export function cartShareErrorMessage(error: unknown, fallbackMessage: string) {
  ...
  const messages: Record<string, string> = {
    ...
    ACTIVE_RESERVATION_LIMIT: "Bạn đang có quá nhiều lượt giữ hàng. Vui lòng hoàn tất hoặc chờ lượt cũ hết hạn.",
    RESERVED_UNITS_LIMIT: "Bạn đang giữ quá nhiều sản phẩm. Vui lòng hoàn tất hoặc chờ lượt cũ hết hạn.",
    SUBMISSION_SESSION_MISMATCH: "Phiên storefront đã thay đổi. Vui lòng chốt lại giỏ hàng.",
